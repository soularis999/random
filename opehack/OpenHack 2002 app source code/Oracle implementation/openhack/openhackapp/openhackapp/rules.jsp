...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	<title>eWEEK eXcellence Awards Program ENTRY RULES and ELIGIBILITY</title>
...
<table width="610" border="0">
	<tr>
		<td>
			...
			<a href="index.jsp"><b>Return to site homepage to start the registration process.</b></a>
