...
<%
	...
	String currentpassword = request.getParameter("currentpassword") == null ? "" : HTMLize(request.getParameter("currentpassword").trim());
	String newpassword1 = request.getParameter("newpassword1") == null ? "" : HTMLize(request.getParameter("newpassword1").trim());
	String newpassword2 = request.getParameter("newpassword2") == null ? "" : HTMLize(request.getParameter("newpassword2").trim());
    ...
    MissingInput = false;
		...
		query = "select userid " +
					"from users " +
						"where userid = '" + SQLize(userid) + "' " +
							"and password = EDPP001_enc.encrypt('" + SQLize(currentpassword) + "')";
		...
		if (recordfound) {
            ...
            "set password = EDPP001_enc.encrypt('" + SQLize(newpassword1) + "'), recordmodificationtimestamp = SYSDATE " +
						"where userid = '" + SQLize(userid) + "'";
			...
			<form>
				<table>
					<tr valign="top">
						...
						<td>
							<input name="currentpassword" type="password" size="10" maxlength="16" value="<%=HTMLize(currentpassword)%>">
					...
					<tr valign="top">
						...
						<td>
							<input name="newpassword1" type="password" size="10" maxlength="16" value="<%=HTMLize(newpassword1)%>">
							<span class="asterisk">*</span>
					...
					<tr valign="top">
						...
						<td>
							<input name="newpassword2" type="password" size="10" maxlength="16" value="<%=HTMLize(newpassword2)%>">
							<span class="asterisk">*</span>
						</td>
					</tr>
					<tr>
