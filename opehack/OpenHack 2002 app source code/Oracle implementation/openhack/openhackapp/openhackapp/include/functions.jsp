...
// Created I N BRYSON 14-06-2002
// Strips out potential characters that could lead to embedded scripts in email
// messages.
public String SMTPize (String sInput) {
...
public void SendMailMessage (String sToName, String sToAddress, String sSubject, String sMessage) {
	...
	try {
		com.oreilly.servlet.MailMessage msg = new com.oreilly.servlet.MailMessage("mail.openhack.com");
		msg.from ("do-not-reply@openhack.com");
		msg.setHeader ("Reply-To","do-not-reply@openhack.com");
		msg.to (sToAddress);
