...
insert into judges (USERID,PASSWORD,ACCESSLEVEL,EMAIL) values ('admin',edpp001_enc.encrypt('bugsy4daisy'), 1, 'timothy_dyck@ziffdavis.com');
commit;
...
insert into categories (CATEGORYHEADING,SORTORDER,CATEGORYNAME,DESCRIPTION,CRITERIA,LEADJUDGE) values ('Preliminary Category', 1.0, 'Server and Desktop Hardware', 'servers, PCs, storage, handhelds, phones', '(no criteria)', 'N');
insert into categories (CATEGORYHEADING,SORTORDER,CATEGORYNAME,DESCRIPTION,CRITERIA,LEADJUDGE) values ('Preliminary Category', 1.0, 'Networking and Management Tools', 'all networking hardware, all network management, VoIP', '(no criteria)', 'N');
insert into categories (CATEGORYHEADING,SORTORDER,CATEGORYNAME,DESCRIPTION,CRITERIA,LEADJUDGE) values ('Preliminary Category', 1.0, 'Security', 'firewalls, IDS, antivirus, pentration testing, OS addons', '(no criteria)', 'N');
insert into categories (CATEGORYHEADING,SORTORDER,CATEGORYNAME,DESCRIPTION,CRITERIA,LEADJUDGE) values ('Preliminary Category', 1.0, 'Personal Productivity', 'desktop apps, e-mail clients, anything with desktop component or used by end users', '(no criteria)', 'N');
insert into categories (CATEGORYHEADING,SORTORDER,CATEGORYNAME,DESCRIPTION,CRITERIA,LEADJUDGE) values ('Preliminary Category', 1.0, 'Developer', 'development tools, web site creation', '(no criteria)', 'N');
insert into categories (CATEGORYHEADING,SORTORDER,CATEGORYNAME,DESCRIPTION,CRITERIA,LEADJUDGE) values ('Preliminary Category', 1.0, 'Server Software', 'e-mail servers, databases, app servers, CRM, ERP, Financial', '(no criteria)', 'N');
insert into categories (CATEGORYHEADING,SORTORDER,CATEGORYNAME,DESCRIPTION,CRITERIA,LEADJUDGE) values ('Preliminary Category', 1.0, 'Other', 'other', '(no criteria)', 'N');
commit;

----------
-- rankings table data

insert into exadmin.rankings (RANKINGSCORE, RANKINGNAME, RANKINGDESCRIPTION) VALUES (0, 'Difficult to categorize', 'None');
insert into exadmin.rankings (RANKINGSCORE, RANKINGNAME, RANKINGDESCRIPTION) values (1, 'Has some promise', 'None');
insert into exadmin.rankings (RANKINGSCORE, RANKINGNAME, RANKINGDESCRIPTION) values (2, 'Potential Top 10', 'None');
insert into exadmin.rankings (RANKINGSCORE, RANKINGNAME, RANKINGDESCRIPTION) values (3, 'Top 10', 'None');
insert into exadmin.rankings (RANKINGSCORE, RANKINGNAME, RANKINGDESCRIPTION) values (4, 'Finalist', 'None');
insert into exadmin.rankings (RANKINGSCORE, RANKINGNAME, RANKINGDESCRIPTION) values (5, 'Winner', 'None');
commit;
