...
<%
	...
	String companyid = request.getParameter("companyid") == null ? "" : request.getParameter("companyid").trim();
	// get parameter from login.jsp
	if (request.getAttribute("from_login_userid") != null) {
		userid = (String) request.getAttribute("from_login_userid");
	...
	if (session.getAttribute("fromsign_up") != null) {
		...
		if (submit.equals("Submit data") || sMissingInput.equals("true")) {
			...
			// get parameters passed from self
			companyname = request.getParameter("companyname") == null ? "" : request.getParameter("companyname").trim();
			...
			companyphone = request.getParameter("companyphone") == null ? "" : request.getParameter("companyphone").trim();
			fax = request.getParameter("fax") == null ? "" : request.getParameter("fax").trim();
			url = request.getParameter("url") == null ? "" : request.getParameter("url").trim();
			creditcardbrand = request.getParameter("creditcardbrand") == null ? "" : request.getParameter("creditcardbrand").trim();
			creditcard = request.getParameter("creditcard") == null ? "" : request.getParameter("creditcard").trim();
			creditcardexpiry = request.getParameter("creditcardexpiry") == null ? "" : request.getParameter("creditcardexpiry").trim();
			billingname = request.getParameter("billingname") == null ? "" : request.getParameter("billingname").trim();
			billingaddress1 = request.getParameter("billingaddress1") == null ? "" : request.getParameter("billingaddress1").trim();
			billingaddress2 = request.getParameter("billingaddress2") == null ? "" : request.getParameter("billingaddress2").trim();
			billingcity = request.getParameter("billingcity") == null ? "" : request.getParameter("billingcity").trim();
			billingstate = request.getParameter("billingstate") == null ? "" : request.getParameter("billingstate").trim();
			billingzip = request.getParameter("billingzip") == null ? "" : request.getParameter("billingzip").trim();
			billingcountry = request.getParameter("billingcountry") == null ? "" : request.getParameter("billingcountry").trim();
			billingphone = request.getParameter("billingphone") == null ? "" : request.getParameter("billingphone").trim();
			checkpayment = request.getParameter("checkpayment") == null ? "" : request.getParameter("checkpayment").trim();

			// check input parameters
			String checkerrormessage = request.getAttribute("msg") == null ? "" : (String)request.getAttribute("msg");
			...
			if (!companyid.equals("") && !companyid.equals("new")) {
				...
				query = "select creditcardbrand, creditcard, creditcardexpiry, billingname, billingaddress1, billingaddress2, billingcity, billingstate, billingzip, billingcountry, billingphone, checkpayment from payment where companyid = " + SQLize(companyid);
				rs = stmt.executeQuery(query);
				recordfound = rs.next();
				if (recordfound) {
					// get payment data
					creditcardbrand = rs.getString(1) == null ? "" : rs.getString(1);	// creditcardbrand is stored as NULL in the database if it is blank
					creditcard = rs.getString(2);
					creditcardexpiry = rs.getString(3);
					billingname = rs.getString(4);
					billingaddress1 = rs.getString(5);
					billingaddress2 = rs.getString(6);
					billingcity = rs.getString(7);
					billingstate = rs.getString(8) == null ? "" : rs.getString(8);	// billingstate is stored as NULL in the database if it is blank
					billingzip = rs.getString(9);
					billingcountry = rs.getString(10);
					billingphone = rs.getString(11);
					checkpayment = rs.getString(12);
				}
			}
		...
		if (submit.equals("Submit data")) {
			...
			if (!bPaid) {
				...
				if (creditcardbrand.equals("")) {
					...
					query += "creditcardbrand = '" + SQLize(creditcardbrand) + "', ";
						...
						query +=
							"creditcard = '" + SQLize(creditcard) + "', " +
							"creditcardexpiry = '" + SQLize(creditcardexpiry) + "', " +
			...
			if (!bPaid) {
				...
				String password = "";
				String useremail = "";
				query = "select username, password, email from users where userid = '" + SQLize(userid) + "'";
				rs = stmt.executeQuery(query);
				recordfound = rs.next();
				if (recordfound) {
				...
				String sMessageText = 
					...
					"able to submit products and/or services created by " + companyname + " for consideration in this award " +
					"program.\n" +
					"\n" +
				...
				request.setAttribute ("msg", "Thank you for your company registration and payment! A confirmation e-mail has been sent to the e-mail address <b>" + useremail + "</b>. You may now proceed to step 3, submitting a new entry for judging. You must still complete this last step before the entry deadline to be in the competition.");
				%>
				<jsp:forward page="index.jsp" />
				<%
			...
			<form action="companycreateedit.jsp">
				...
				<table>
					<tr valign="top">
						...
						<td>
							<input name="companyname" size="30" maxlength="50" type="text" value="<%=companyname%>">
					...
					<tr valign="top">
						...
						<td>
							<input name="address1" size="30" maxlength="30" type="text" value="<%=address1%>">
							<span class="asterisk">*</span>
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							<input name="address2" size="30" maxlength="30" type="text" value="<%=address2%>">
						</td>
					</tr>
					<tr valign="top">
						<td align="right">City:</td>
						<td>
							<input name="city" size="30" maxlength="30" type="text" value="<%=city%>">
							<span class="asterisk">*</span>
						</td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top">
						...
						<td>
							<input name="zip" size="15" maxlength="15" type="text" value="<%=zip%>">
							<span class="asterisk">*</span>
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							<input name="country" size="30" maxlength="30" type="text" value="<%=country%>">
							<span class="asterisk">*</span>
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							<input name="companyphone" size="20" maxlength="20" type="text" value="<%=companyphone%>">
							<span class="asterisk">*</span>
						</td>
					</tr>
					<tr>
					...
					<tr valign="top">
						...
						<td>
							<input name="fax" size="20" maxlength="20" type="text" value="<%=fax%>">
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr valign="top">
						...
						<td>
							<input size="30" name="url" maxlength="100" type="text" value="<%=url%>">
							<span class="asterisk">*</span>
						</td>
					</tr>
				</table>
				...
				<table border="1" align="center">
					...
					<tr valign="top">
						...
						<td>
							<input name="creditcard" size="20" maxlength="20" type="text" value="<%=creditcard%>">
							<span class="asterisk">*</span>
						</td>
						<td></td>
					</tr>
					<tr valign="top">
						...
						<td>
							<input name="creditcardexpiry" size="7" maxlength="7" type="text" value="<%=creditcardexpiry%>">
							<span class="asterisk">*</span>
						</td>
						<td></td>
					</tr>
					...
					<tr valign="top">
						...
						<td>
							<input name="billingaddress1" size="30" maxlength="30" type="text" value="<%=billingaddress1%>">
							<span class="asterisk">*</span>
						</td>
						<td></td>
					</tr>
					<tr valign="top">
						...
						<td>
							<input name="billingaddress2" size="30" maxlength="30" type="text" value="<%=billingaddress2%>">
						</td>
						<td></td>
					</tr>
					<tr valign="top">
						...
						<td>
							<input name="billingcity" size="30" maxlength="30" type="text" value="<%=billingcity%>">
							<span class="asterisk">*</span>
						</td>
						<td></td>
					</tr>
					...
					<tr valign="top">
						...
						<td>
							<input name="billingzip" size="15" maxlength="15" type="text" value="<%=billingzip%>">
							<span class="asterisk">*</span>
						</td>
						<td></td>
					</tr>
					<tr valign="top">
						...
						<td>
							<input name="billingcountry" size="30" maxlength="30" type="text" value="<%=billingcountry%>">
							<span class="asterisk">*</span>
						</td>
						<td></td>
					</tr>
					<tr valign="top">
						...
						<td>
							<input name="billingphone" size="20" maxlength="20" type="text" value="<%=billingphone%>">
							<span class="asterisk">*</span>
						</td>
						<td></td>
					</tr>
