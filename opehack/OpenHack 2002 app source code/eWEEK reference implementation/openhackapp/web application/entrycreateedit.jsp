...
<%
	...
	productname = request.getParameter("productname") == null ? "" : request.getParameter("productname").trim();
	version = request.getParameter("version") == null ? "" : request.getParameter("version").trim();
	announcementdate = request.getParameter("announcementdate") == null ? "" : request.getParameter("announcementdate").trim();
	shipdate = request.getParameter("shipdate") == null ? "" : request.getParameter("shipdate").trim();
	url = request.getParameter("url") == null ? "" : request.getParameter("url").trim();
	nda = request.getParameter("nda") == null ? "" : request.getParameter("nda").trim();
	targetaudience = request.getParameter("targetaudience") == null ? "" : request.getParameter("targetaudience").trim();
	description = request.getParameter("description") == null ? "" : request.getParameter("description").trim();
	businessproblem = request.getParameter("businessproblem") == null ? "" : request.getParameter("businessproblem").trim();
	competitors = request.getParameter("competitors") == null ? "" : request.getParameter("competitors").trim();
	keyfeatures = request.getParameter("keyfeatures") == null ? "" : request.getParameter("keyfeatures").trim();
	price = request.getParameter("price") == null ? "" : request.getParameter("price").trim();
	customerreferences = request.getParameter("customerreferences") == null ? "" : request.getParameter("customerreferences").trim();
			...
			<form method="post" action="entrycreateedit.jsp">
				...
				<table width="610" cellpadding="4">
					...
					<tr>
						...
						<td width="70%" valign="bottom">
							<input name="productname" type="text" size="30" maxlength="100" value="<%=productname%>">
					...
					<tr>
						...
						<td width="70%" valign="bottom">
							<input name="version" type="text" size="30" maxlength="30" value="<%=version%>">
							<span class="asterisk">*</span>
						</td>
					</tr>
					<tr>
						...
						<td width="70%" valign="bottom">
							<input name="announcementdate" type="text" size="30" maxlength="30" value="<%=announcementdate%>">
					...
					<tr>
						...
						<td width="70%" valign="bottom">
							<input name="shipdate" type="text" size="30" maxlength="30" value="<%=shipdate%>">
							<span class="asterisk">*</span><br>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="70%" valign="bottom">
							<input name="url" type="text" size="30" maxlength="100" value="<%=url%>">
						</td>
					</tr>
					<tr>
